# [full stack apache2 Rails for everyone with docker compose](https://github.com/damalis/full-stack-apache2-rails-for-everyone-with-docker-compose)

If You want to build a website with Rails at short time; 

#### Full stack Apache2 Rails:
[![Rails](https://img.shields.io/badge/Ruby%20on%20Rails-CC0000?logo=ruby&logoColor=white)](https://rubyonrails.org/)
...
The containers are now built and running. You should be able to access the Rails installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
...
```config.hosts << "DOMAIN_NAME"``` then ```docker container restart rails```
