...
echo "======================================================================="
echo "|                                                                     |"
echo "|      full-stack-apache2-rails-for-everyone-with-docker-compose      |"
echo "|                         by Erdal ALTIN                              |"
echo "|                                                                     |"
echo "======================================================================="
sleep 2
...
if [ -x "$(command -v docker)" ] && [ "$(docker compose version)" ]; then
	...
	# installing Rails and the other services
	docker compose up -d & export pid=$!
	echo "Rails and the other services installing proceeding..."
	echo ""
	wait $pid
	if [ $? -eq 0 ]
	then
		...
		echo ""
		echo "Error! could not installed Rails and the other services with docker compose" >&2
		echo ""
		exit 1
	fi
else
